 ...
 */
    ...
    */
    app.post('/auth/signup', (0, validateResource_1.default)(registration_schema_1.default), auth_controller_1.registerUser);
    /**
    * @swagger
    * /auth/login:
    *   post:
    ...
    */
    app.post('/auth/login', (0, validateResource_1.default)(login_schema_1.default), auth_controller_1.loginUser);
    //   
    /**
 * @swagger
 * /api/url:
 ...
 */
    app.post("/api/url", auth_middleware_1.authenticateToken, (0, validateResource_1.default)(createShortUrl_schema_1.default), shortUrl_controller_1.createShortUrl);
    /**
     * @swagger
     * /short/{shortId}:
     *   get:
     ...
     */
    app.get("/short/:shortId", shortUrl_controller_1.handleRedirect);
    /**
    * @swagger
    * /api/analytics:
    *   get:
